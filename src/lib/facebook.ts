...
export function getFacebookOAuthUrl(redirectUri: string, state: string): string {
  ...
  const scopes = "ads_management,ads_read,business_management,public_profile,pages_show_list,pages_read_engagement,pages_manage_posts,instagram_basic,instagram_content_publish"
